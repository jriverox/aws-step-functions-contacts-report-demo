...
```bash
aws-step-functions-contacts-report-demo$ sam build
```
...
```bash
aws-step-functions-contacts-report-demo$ sam logs -n StockCheckerFunction --stack-name aws-step-functions-contacts-report-demo --tail
```
...
```bash
aws-step-functions-contacts-report-demo$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name aws-step-functions-contacts-report-demo
```
